-- Create SQL login and user for martin_autofiq_user
...
ELSE
BEGIN
    PRINT '⚠️  Login already exists: martin_autofiq_user'
END
GO

-- Step 2: Use autofiq database and create user
USE autofiq
GO
...
BEGIN
    ...
    PRINT '✅ User created: martin_autofiq_user in autofiq'
END
ELSE
BEGIN
    PRINT '⚠️  User already exists in autofiq'
END
GO
...
-- Verify
SELECT 'martin_autofiq_user' AS Username, @@SERVERNAME AS Server, DB_NAME() AS [Database], 'Ready' AS Status
GO
