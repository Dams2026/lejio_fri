...
const isAzureSwaHost = typeof window !== 'undefined' && window.location.hostname.includes('azurestaticapps.net');

if (isAzureSwaHost && 'serviceWorker' in navigator) {
  // Avoid stale PWA caches on Azure SWA preview hosts.
