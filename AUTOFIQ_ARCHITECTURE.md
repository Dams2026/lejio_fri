# AUTOFIQ - Architecture & Development Plan

## 1. HVAD ER AUTOFIQ?

**AUTOFIQ** er en hvid-label billeudleningsplatform hvor:
- **Lessors** (billejeudlejere) kan oprette deres egen billeudlejingswebsite
- **Admin** styrer AUTOFIQ platformen selv
...
┌─────────────────────────────────────┐
│     Frontend (React + Vite)         │
│  ├─ AUTOFIQ Landing (public)            │
│  ├─ AUTOFIQ Login/Signup                │
│  ├─ AUTOFIQ Dashboard (lessor)          │
...
- **Mock test user:** martin@autofiq.dk / password: test
...
### 4.2 AUTOFIQ Dashboard (✅ PARTIALLY DONE)
- **Route:** `/autofiq/dashboard`
...
- AUTOFIQ dashboard loads without errors
...
**Test flow:**
1. Go to `https://zealous-stone-04c86dd03.2.azurestaticapps.net/autofiq/login`
2. Login: martin@autofiq.dk / test
3. See AUTOFIQ Dashboard
...
│   ├── pages/
│   │   ├── fri/
│   │   │   ├── dashboard/Dashboard.tsx ← AUTOFIQ Dashboard
...
│   │   ├── useFriAuth.tsx ← AUTOFIQ auth hook
...
3. **Authentication:**
   - Mock test user: `martin@autofiq.dk` / `test`
...
**Repository:**
- GitHub: https://github.com/martinjensen9988-sudo/autofiq-b75cff1f
- Branch: main (default)
- CI/CD: GitHub Actions (automatic Azure deployment)

**Handoff Instructions:**
- New developers must read AUTOFIQ_ARCHITECTURE.md first
...
### Frontend Testing:
- [ ] Login page loads
- [ ] Can login with martin@autofiq.dk / test
...
- Dashboard: `src/pages/autofiq/dashboard/Dashboard.tsx`
